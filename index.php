	...
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_contact_no" class="form-control input_pass" placeholder="PR Number/ID Number" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                                    </div>
                                    <input type="password" name="su_password" id="su_password" class="form-control input_pass" placeholder="Password" required />
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="contact_no" class="form-control input_user" placeholder="PR Number/ID Number" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                ...
                ?>
                        <span class="bg-white text-danger text-center my-3"> This PR-number or Email already exist  </span>
                <?php
...
<?php 
    ...
    if(isset($_POST['sign_up_btn'])) {
        ...
        //$fetchingData = mysqli_query($db, "SELECT * FROM users WHERE contact_no = '". $su_contact_no ."'") or die(mysqli_error($db));
        $fetchingData = mysqli_query($db, "SELECT * FROM users WHERE contact_no = '$su_contact_no' OR email = '$su_email'") or die(mysqli_error($db));
        if(mysqli_num_rows($fetchingData) > 0) 
        {
            // User already exists
            $data = mysqli_fetch_assoc($fetchingData)
             ?>
             <script> location.assign("index.php?sign-up=1&Exist=1"); </script>
             <?php
        } 
        else
        {
...
<script>
    ...
    function validatePassword() {
        var passwordInput = document.getElementById('su_password');
        var password = passwordInput.value.trim();

        // Regular expression to match exactly 9 digits
        var passwordRegex = /^\d{9}$/;
